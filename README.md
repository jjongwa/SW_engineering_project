...
| ---------------------------------------------------- | ------------------------------------------------------------ |
| 1. 사용자 정보를 입력받고 회원가입 action을 실행한다.| 2. 입력받은 사용자 정보로 회원가입을 진행하고 가입된 회원의 이름, 주민번호, ID 비밀번호를 출력한다.|

## 2. 회원탈퇴
| Actor Action                                         | System Response                                              |
| ---------------------------------------------------- | ------------------------------------------------------------ |
| 1. 회원탈퇴 action을 실행한다.| 2. 회원탈퇴가 성공하면 탈되한 계정의 ID를 출력한다.|

## 3. 로그인
| Actor Action                                         | System Response                                              |
| ---------------------------------------------------- | ------------------------------------------------------------ |
| 1. ID와 비밀번호를 입력받고 로그인 action을 실행한다.| 2. 로그인이 성공하면 해당 ID와 비밀번호를 출력한다.|

## 4. 로그아웃
| Actor Action                                         | System Response                                              |
| ---------------------------------------------------- | ------------------------------------------------------------ |
| 1. 로그아웃 action을 실행한다.| 2. 로그아웃에 성공하면 해당 ID를 출력한다.|

## 5. 판매의류 등록
| Actor Action                                         | System Response                                              |
| ---------------------------------------------------- | ------------------------------------------------------------ |
| 1. 상품명, 제작회사명, 가격, 수량을 입력받고 판매의류 등록 action을 실행한다.| 2. 등록에 성공하면 등록한 제품의 상품명, 제작회사명, 가격, 수량을 출력한다.|


## 6. 상품 정보 검색
| Actor Action                                         | System Response                                              |
| ---------------------------------------------------- | ------------------------------------------------------------ |
| 1. 상품명을 입력받고 상품 정보 검색 action을 실행한다.| 2. 해당 상품에 대한 판매자ID, 상품명, 제작회사명, 가격, 남은수량, 평균 구매만족도를 출력한다.|


## 7. 상품 구매
| Actor Action                                         | System Response                                              |
| ---------------------------------------------------- | ------------------------------------------------------------ |
| 1. 검색한 상품에 대해 상품 구매 action을 실행한다.| 2.해당 상품에 대한 구매를 진행한 후 판매자ID와 상품명을 출력한다.|

## 8. 상품 구매 내역 조회
| Actor Action                                         | System Response                                              |
| ---------------------------------------------------- | ------------------------------------------------------------ |
| 1. 상품 구매 내역 조회 action을 실행한다.| 2.자신의 구매 내역(판매자ID, 상품명, 제작회사명, 가격, 평균 구매만족도)을 출력한다.|

## 9. 구매만족도 평가
| Actor Action                                         | System Response                                              |
| ---------------------------------------------------- | ------------------------------------------------------------ |
| 1. 상품명과 구매만족도를 입력받고 상품 구매 내역 조회 action을 실행한다.| 2. 해당 상품에 대한 구매 만족도를 생성한 후 해당 상품의 판매자ID, 상품명, 구매만족도를 출력한다.|
